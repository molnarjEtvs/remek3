            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                     ...
                     <form method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" value="{{$postData->title}}" name="title" id="title" maxlength="150" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="150">
                        @error('title')
                            {{$message}}
                        @enderror
                        <br>
                        ...
                        rows="4" placeholder="400">{{$postData->text}}</textarea>
                        @error('post')
                            {{$message}}
                        @enderror
                        <br>
